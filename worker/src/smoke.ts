...
import { compareEntries, scoreEntry } from "./judge";

// Two sample entries: a self-aware clever one vs. a generic plea. Used only to verify the
// scoring + comparison paths end to end against the live panel.
const SAMPLE_A =
