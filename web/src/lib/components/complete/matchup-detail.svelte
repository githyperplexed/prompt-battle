...
{#if detail}
	<Card>
		...
		<div
			class="mt-3.5 flex flex-col gap-1 rounded-control border border-[color-mix(in_oklch,var(--color-acc),transparent_66%)] bg-[color-mix(in_oklch,var(--color-acc),transparent_90%)] p-3.5"
		>
